...
try:
    ...
    topic_summary_wc = ec1.number_input("Topic Summary Word Count", value=30, min_value=1)
    topic_summary_vo_wc = ec1.number_input("Topic Summary VoiceOver Word Count", value=50, min_value=1)

    bullets_per_slide = ec2.number_input("Number of Bullets per Slide", value=4, min_value=1)
