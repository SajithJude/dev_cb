    ...
    if ex:
        for topic_key, topic_value in st.session_state.new_dict.items():
            ...
            for subtopic in topic_value["Subtopics"]:
                ...
                subtopic_bullet_prompt = f"generate {num_bullets_per_slide} number of bullet points with {num_words_bullet} number of words per bullet from the following paragraph {subtopic_content}\n, give the output as a json list."
